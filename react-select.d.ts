...
interface ReactSelectProps extends React.Props<ReactSelect> {
    /**
...
interface ReactAsyncSelectProps extends React.Props<ReactSelect> {
    cache?: any;
    loadOptions?: () => void;
...
interface ReactSelectClass extends React.ComponentClass<ReactSelectProps> {
    Async: React.ComponentClass<ReactAsyncSelectProps>;
}

declare var select: ReactSelectClass;
export = select;
